...
import info.mbobiosio.journalapp.utils.PreferenceHelper;

public class FirstLaunchActivity extends AppCompatActivity {

    private ViewPager viewPager;
    private FirstLaunchPagerAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new FirstLaunchPagerAdapter();
    ...
    private void addBottomDots(int currentPage) {
        ...
        for (int i = 0; i < dots.length; i++) {
            ...
            dots[i].setText(Constants.fromHtml("&#8226;"));
    ...
    public class FirstLaunchPagerAdapter extends PagerAdapter {
        ...
        public FirstLaunchPagerAdapter() {
        }
